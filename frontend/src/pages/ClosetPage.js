...
function ClosetPage(props) {
    ...
    function renderContent() {
        ...
        let clothesElements = closets.map((closet, index) => {
            ...
            return (
                ...
                <h3 className="closettitle"> {closet.name} </h3>
                <hr />
                {items}
                <hr />
                </div>
    ...
    return (
        <div className="container">
            <h1 className="heading">My Closet.</h1>
            <Profile img="https://as1.ftcdn.net/jpg/04/23/79/26/500_F_423792674_pmzV6lz1ZIclb6yJ1aVwW6aT3e7uVhEA.jpg" />
            <br></br>
            <h2 style={{
                size: "5px",
                color:"burlywood"
